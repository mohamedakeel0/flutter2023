...
//main colors
    ...
    buttonTheme: const ButtonThemeData(
      ...
      splashColor: AppColors.grayDark,
    ),
    ...
    textTheme: const TextTheme(
        headline5: TextStyle(height: 0.0,
            fontSize: FontSize.s18,color: AppColors.gray,
            fontWeight: FontWeight.w300,
            fontFamily: 'DancingScript'
        ),
        subtitle1: TextStyle(height: 0.0,
...
//hint Style
      ...
      enabledBorder: OutlineInputBorder(
        borderSide: BorderSide(color: AppColors.gray, width: AppSize.s1_5),
      ),
